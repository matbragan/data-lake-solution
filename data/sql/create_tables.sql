...
CREATE TABLE IF NOT EXISTS minio.landing.mssql_users_parquet (
    ...
    external_location = 's3a://landing/com.lake-solution.data/mssql/users/parquet',
    format = 'PARQUET'
);
...
CREATE TABLE minio.landing.mssql_credit_card_parquet (
    ...
    external_location = 's3a://landing/com.lake-solution.data/mssql/credit_card/parquet',
    format = 'PARQUET'
);
...
CREATE TABLE minio.landing.postgres_payments_parquet (
    ...
    external_location = 's3a://landing/com.lake-solution.data/postgres/payments/parquet',
    format = 'PARQUET'
);
...
CREATE TABLE minio.landing.postgres_subscription_parquet (
    ...
    external_location = 's3a://landing/com.lake-solution.data/postgres/subscription/parquet',
    format = 'PARQUET'
);
...
CREATE TABLE minio.landing.postgres_vehicle_parquet (
    ...
    external_location = 's3a://landing/com.lake-solution.data/postgres/vehicle/parquet',
    format = 'PARQUET'
);
...
CREATE TABLE minio.landing.mongodb_rides_parquet (
    ...
    external_location = 's3a://landing/com.lake-solution.data/mongodb/rides/parquet',
    format = 'PARQUET'
);
...
CREATE TABLE minio.landing.mongodb_stripe_parquet (
    ...
    external_location = 's3a://landing/com.lake-solution.data/mongodb/stripe/parquet',
    format = 'PARQUET'
);
...
CREATE TABLE minio.landing.mongodb_users_parquet (
    ...
    external_location = 's3a://landing/com.lake-solution.data/mongodb/users/parquet',
    format = 'PARQUET'
);