...
class MinioStorage(object):
    ...
    def upload_data(self, data, object_name, ds_type, format_type):
        ...
        file_loc_root_folder: str = "com.lake-solution.data"
    ...
    def write_file(self, ds_type: str, format_type: str):
        ...
        if ds_type == "mssql":
            ...
            dt_users = users.get_multiple_rows(gen_dt_rows=count_rows)
            ...
            dt_payments = payments.get_multiple_rows(gen_dt_rows=count_rows)
            dt_subscription = api.api_get_request(url=urls["subscription"], params=params)
            dt_vehicle = vehicle.get_multiple_rows(gen_dt_rows=count_rows)
            ...
            dt_rides = rides.get_multiple_rows(gen_dt_rows=count_rows)
